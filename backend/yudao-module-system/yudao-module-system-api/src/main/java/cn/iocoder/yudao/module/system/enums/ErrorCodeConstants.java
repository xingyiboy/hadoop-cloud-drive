...
public interface ErrorCodeConstants {
    ...
    ErrorCode HADOOP_FILE_NOT_EXISTS = new ErrorCode(1_003_000_005, "hadoop文件不存在");
    ErrorCode HADOOP_FILE_IS_DIRECTORY = new ErrorCode(1_003_000_006, "不能下载目录");
    ErrorCode HADOOP_FILE_PERMISSION_DENIED = new ErrorCode(1_003_000_007, "没有权限访问该文件");
    ErrorCode HADOOP_FILE_DOWNLOAD_FAIL = new ErrorCode(1_003_000_008, "文件下载失败");

    // 使用 1-003-000-000 段
    ErrorCode SLIDESHOW_NOT_EXISTS = new ErrorCode(1_003_000_000, "轮播图不存在");
    // ========== 新闻资讯
    ErrorCode NEWS_NOT_EXISTS = new ErrorCode(1_003_000_001, "新闻资讯不存在");
    // ========== 论坛
    ErrorCode FORUM_NOT_EXISTS = new ErrorCode(1_003_000_002, "论坛不存在");
    // ========== 教育
    ErrorCode EDUCATION_NOT_EXISTS = new ErrorCode(1_003_000_003, "教育不存在");
    // ========== 历史
    ErrorCode HISTORY_NOT_EXISTS = new ErrorCode(1_003_000_004, "历史不存在");

    // ========== 历史记录
    ErrorCode HISTORY_RECORD_NOT_EXISTS = new ErrorCode(1_003_000_004, "历史记录不存在");
    ...
    ErrorCode FILE_NAME_EXISTS = new ErrorCode(1_002_029_000, "文件名已存在");
}
